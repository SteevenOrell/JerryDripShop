...
class NavB extends React.Component {
  ...
  <Navbar.Toggle aria-controls="responsive-navbar-nav" id="toggleMenu" onClick={()=>{this.onToggleClick()}} />
  <Navbar.Collapse id="responsive-navbar-nav">
    <Nav className="mr-auto">
     
   
    <NavDropdown title={<span className="colorNavB" > Men</span>}  className="middleLinks" 
      ...
      <NavDropdown title={<span className="colorNavB" >Women</span>}  className="middleLinks" 
      ...
      <NavDropdown title={<span className="colorNavB" >Kids</span>}  className="middleLinks"
      ...
      <NavDropdown title={<span className="colorNavB" >Customer Care</span>}  className="middleLinks" 
